...
public class CarRentalCompany implements ICarRentalCompany {
	...
	public List<Reservation> getReservationsByRenter(String clientName) throws RemoteException {
		List<Reservation> reservationRenter = new ArrayList<>();
		for(Car c: cars) {
			reservationRenter.addAll( c.getAllReservationByRenter(clientName ) );
		}		
		return reservationRenter;
	}
	...
	public int getNumberOfReservationsForCarType(String carType) throws RemoteException {
		...
		for(Car c: cars) {
			if(c.getType().getName().equals(carType)) {
				totalReservations += c.getNbReservations();
			}
		}		
