...
public class RentalServer {
	...
	public static void main(String[] args) throws ReservationException,
		...
		ICarRentalCompany rentalComp = new CarRentalCompany(data.name, data.regions, data.cars);
		
		System.setSecurityManager(null);
		 try {
			 	ICarRentalCompany ICRC = (ICarRentalCompany) UnicastRemoteObject.exportObject(rentalComp,0);
			 	
			 	//change this for non local registries
	            Registry registry = LocateRegistry.getRegistry();
	            registry.rebind("Hertz", ICRC);
